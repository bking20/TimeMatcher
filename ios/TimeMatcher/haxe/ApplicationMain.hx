...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("TimeMatcher", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("TimeMatcher", null, 0, 0);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["file"] = "TimeMatcher";
		app.meta["name"] = "TimeMatcher";
		app.meta["packageName"] = "TimeMatcher";
		...
		app.window.context.attributes.background = 12255232;
